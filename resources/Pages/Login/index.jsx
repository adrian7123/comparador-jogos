...
class index extends Component {
    render() {
        return (
            <div class="grid w-screen h-screen place-items-center bg-secondary">
                <form class="bg-primary shadow-md rounded px-8 pt-6 pb-8 mb-4">
                    <div class="mb-4">
                    <label class="block text-terciary text-sm font-bold mb-2" for="username"> E-mail </label>
                    ...
                    <div class="mb-4">
                    <label class="block text-terciary text-sm font-bold mb-2" for="password">Senha</label>
                    ...
                    <button class="bg-terciary hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" type="button">
                        Entrar
                    </button>
                    </div>

                    <div>
                    <a class="inline-block align-baseline font-bold text-sm text-terciary" href="#">
